                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('product.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input id="sku" class="form-control" type="text" name="sku" value="{{ old('sku') }}">
                                @if($errors->has('sku'))
                            ...
                            <div class="form-group">
                                ...
                                <input id="qty" class="form-control" type="number" min="0" name="qty" value="{{ old('qty') }}">
                                @if($errors->has('qty'))
                            ...
                            <div class="form-group">
                                ...
                                <input id="retailPrice" class="form-control" type="text" name="retailPrice" value="{{ old('retailPrice') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input id="wholeSalePrice" class="form-control" type="text" name="wholeSalePrice" value="{{ old('wholeSalePrice') }}">
